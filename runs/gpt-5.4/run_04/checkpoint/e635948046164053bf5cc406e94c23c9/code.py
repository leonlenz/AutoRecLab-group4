...
def print_split_note() -> None:
    print(
        f"Using OmniRec UserHoldout(validation_size={VALIDATION_SIZE}, test_size={TEST_SIZE}) "
        f"to approximate a user-based 80/20 holdout while avoiding the documented API crash for validation_size=0.0."
    )
