...
def main():
    ...
    summary = {
        ...
        "notes": {
            ...
            "split_fix": "Used UserHoldout(validation_size=0.01, test_size=0.20) because validation_size=0.0 is invalid in OmniRec UserHoldout.",
            "implicit_conversion": "MovieLens100K and Amazon2014VideoGames use RatingFilter(lower=4) to match strict rating > 3 before 5-core pruning.",
        },
        "files": {
