...
==============================================================================
Tests three LensKit algorithms (Pop, ItemKNN, ALS/ImplicitMF) on three datasets
...
ALGORITHM_CONFIGS = {
    ...
    LensKit.ImplicitMFScorer: {
        "features": 50,   # embedding_size = 50
        "iterations": 100,  # epochs = 100
        "feedback": "implicit",
    },
}
...
def main():
    ...
    for seed_idx, seed in enumerate(RANDOM_SEEDS):
        ...
        for ds_name, raw_ds in raw_datasets.items():
            ...
            # validation_size=0.0 means no validation set, test_size=0.2 means 20% for test
