...
def main():
    ...
    #
    # IMPORTANT: Apply MakeImplicit BEFORE CorePruning.
    ...
    for seed_idx, seed in enumerate(RANDOM_SEEDS):
        ...
        for ds_name, raw_ds in raw_datasets.items():
            ...
            # Apply user-based holdout split: 80% train, 0% val, 20% test
            # Using validation_size=0.0 results in an empty validation set
            ...
            try:
                ...
                for ds_id, df_results in results_dict.items():
                    ...
                    for _, row in df_results.iterrows():
                        ...
                        # Normalize algorithm name (strip hash suffix for cleaner display)
                        # Keep full name for uniqueness but use short form for reporting
