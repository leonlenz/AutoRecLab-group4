...
def preprocess_dataset(spec, seed):
    ...
    # NOTE: UserHoldout requires both validation_size and test_size > 0 (when float).
    # Using validation_size=0.1 gives a 70/10/20 train/val/test split.
    # test_size=0.2 gives the 20% test split as originally intended.
