...
from dataloader.loaders.base import Loader
from dataloader.util import get_data_dir, is_valid_url, verify_checksum
...
for p in Path(__file__).parent.glob("*.py"):
    module = p.stem
    if module != "__init__":
        importlib.import_module(f"dataloader.loaders.{module}")
